...
#### Specifications
- **Data Sources**: Import data from two source systems(ERP and CRM) provided by CSV
- **Data Quality**: Cleanse and resolve data quality issues prior to analysis
- **Integration**: Combine both sources into a single, user-friendl data model designed for analytical queries
